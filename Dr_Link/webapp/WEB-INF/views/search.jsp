				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-md-12 col-lg-8 col-xl-9">
							...
							<c:forEach var="list" items="${getSearch}">
							<!-- Doctor Widget -->
							<div class="card">
								<div class="card-body">
									<div class="doctor-widget">
										<div class="doc-info-left">
											...
											<div class="doc-info-cont">
												...
												<h5 class="doc-department"><img src="resources/img/specialities/specialities-05.png" class="img-fluid" alt="Speciality">${list.d_dept }</h5>
												<div class="rating">
													...
													<span class="d-inline-block average-rating">${list.d_rank }</span>
												</div>
												<div class="clinic-services">
													<span>${list.d_field }</span>
													<!-- <span>여드름</span> -->
												</div>
											</div>
										</div>
