						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							<div class="doc-review review-listing">
								...
								<ul class="comments-list">
									...
									<li>
										<div class="comment">
											<img class="avatar rounded-circle" alt="User Image" src="resources/img/patients/patient.jpg">
											<div class="comment-body">
												<div class="meta-data">
													<span class="comment-author">Richard Wilson</span>
													<span class="comment-date">Reviewed 2 Days ago</span>
										...
										<ul class="comments-reply">
											...
											<li>
												<div class="comment">
													<img class="avatar rounded-circle" alt="User Image" src="resources/img/doctors/doctor-thumb-02.jpg">
													<div class="comment-body">
														<div class="meta-data">
															<span class="comment-author">Dr. Darren Elder</span>
															<span class="comment-date">Reviewed 3 Days ago</span>
									...
									<li>
										<div class="comment">
											<img class="avatar rounded-circle" alt="User Image" src="resources/img/patients/patient2.jpg">
											<div class="comment-body">
												<div class="meta-data">
													<span class="comment-author">Travis Trimble</span>
													<span class="comment-date">Reviewed 4 Days ago</span>
									...
									<li>
										<div class="comment">
											<img class="avatar rounded-circle" alt="User Image" src="resources/img/patients/patient3.jpg">
											<div class="comment-body">
												<div class="meta-data">
													<span class="comment-author">Carl Kelly</span>
													<span class="comment-date">Reviewed 5 Days ago</span>
									...
									<li>
										<div class="comment">
											<img class="avatar rounded-circle" alt="User Image" src="resources/img/patients/patient4.jpg">
											<div class="comment-body">
												<div class="meta-data">
													<span class="comment-author">Michelle Fairfax</span>
													<span class="comment-date">Reviewed 6 Days ago</span>
									...
									<li>
										<div class="comment">
											<img class="avatar rounded-circle" alt="User Image" src="resources/img/patients/patient5.jpg">
											<div class="comment-body">
												<div class="meta-data">
													<span class="comment-author">Gina Moore</span>
													<span class="comment-date">Reviewed 1 Week ago</span>
									...
									<li>
										<div class="comment">
											<img class="avatar rounded-circle" alt="User Image" src="resources/img/patients/patient9.jpg">
											<div class="comment-body">
												<div class="meta-data">
													<span class="comment-author">Walter Roberson</span>
													<span class="comment-date">Reviewed 1 Week ago</span>
									...
									<li>
										<div class="comment">
											<img class="avatar rounded-circle" alt="User Image" src="resources/img/patients/patient8.jpg">
											<div class="comment-body">
												<div class="meta-data">
													<span class="comment-author">Daniel Griffing</span>
													<span class="comment-date">Reviewed on 1 Nov 2019</span>
